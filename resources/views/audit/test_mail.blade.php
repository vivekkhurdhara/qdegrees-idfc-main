				...
				<tr>
					<td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
						...
						<div class="text" style="padding: 2em 0.5em; text-align: left;">
							...
							<strong style="font-family: 'Work Sans', sans-serif; color:red; font-size: 16px;">Hi {{$audit->collectionManagerData->name}},</strong>
							<br/>
							<br/>
							<div>
								...
								<strong style=" font-family: 'Work Sans', sans-serif; padding-top: 20px;">This is to
									apprise you that schedule <strong style="color:red;">{{ucfirst($audit->qmsheet->type)}}</strong> audit has
