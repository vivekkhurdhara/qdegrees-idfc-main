...
<body style="background: #fafafa; padding: 50px;">
  ...
  <div style="height:auto;position: relative; padding:50px; margin-bottom: 50px; background: #fff;">
    ...
    <div style="text-align:center;">
      ...
      <img src="<?php echo e(URL::asset('public/pdfImage/background.jpg')); ?>"  style="width:100%;">

    </div>

    <div  class="cls_002" style="position: absolute;      right: 50%;      margin: auto;      left: 50%;      width: 430px;      font-size: 26px;      bottom: 125px;      color: #fff;">

      <span class="cls_002"><?php echo e($state->name ?? ''); ?> - Score Card - Wave_IV</span>
  ...
  <?php $__currentLoopData = $chunkdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="pageA4" style="position: relative;padding-bottom:45px;margin-bottom: 28px; background:#fff; margin-bottom: 50px; padding:50px;">
    ...
    <table class="exceptional"  width="100%">
      ...
      <tr>
        ...
        <td align='left'><h2 style="margin:0px;text-align:left;"><?php echo e($state->name ?? ''); ?> – Branches Covered

        </h2>

      </td>

      <td align="right"><img src="<?php echo e(URL::asset('public/pdfImage/logo.jpg')); ?>" style=" vertical-align:bottom; width:150px;    margin-left: auto;              display: block;" /></td>
  ...
  <table  class="list exceptional" width="" style="width:100%; border-spacing: 0px; text-align: center;" >
    ...
    <tr>
      ...
      <td class="list-td" style="padding: 20px;" colspan="2"><img src="<?php echo e(URL::asset('public/pdfImage/state_map_india/'.($state->name ?? '').'.jpg')); ?>" alt="" style="display: block; margin: auto; height: 500px; max-width: 100%;"/></td>
          ...
          <tbody>
            ...
            <tr >
              ...
              <td colspan="12" style="padding: 0px;">
                ...
                <h3 style="display:block; margin-top:30px; font-weight: 100; text-align: left" colspan="1"><img src="<?php echo e(URL::asset('public/pdfImage/location.svg')); ?>" class="" alt="" style="height: 24px; "/><?php echo e($item->city->name??''); ?></h3>

                <div class="card-body" style="background:#dae3f3; padding:10px 20px; margin-bottom: 20px; text-align: left;">

                  <p>  

                    <strong><?php echo e($item->city->name ?? ''); ?> Head Office:</strong><br/>
  ...
  <div class="footer">
    ...
    <div style="width:33%;display:inline-block;">
      <img src="<?php echo e(URL::asset('public/pdfImage/logo-qdegrees.png')); ?>" style="height: 38px;">
    </div>

    <div style="width:33%;display:inline-block;text-align:center;">

      <div><img src="<?php echo e(URL::asset('public/pdfImage/footer-middle.jpg')); ?>" style="width: 100px;"></div>
...
<div class="pageA4" style="position: relative;padding-bottom:45px;margin-bottom: 28px; background:#fff; margin-bottom: 50px; padding:50px;">
  ...
  <table  width="100%">
    ...
    <tr>
      ...
      <td align='left'><h2 style="margin:0px;text-align:left;">IDFC First - <?php echo e($state->name ?? ''); ?> Branch & Agency</h2>
  ...
  <table  class="" width="" style="width:100%; border-spacing: 0px; text-align: center; width: 100%;" >
    ...
    <thead style=" background:#c55a11;">
      ...
      <tr >
        ...
        <th class="" style="padding: 20px; background:#c55a11;" colspan="100"><?php echo e($state->name ?? ''); ?> Branch & Agency</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="list-td" style="padding: 20px; text-align: left;" > 
          ...
          <span class="<?php echo e(($item->name==$value->name)?'active':''); ?>"><?php echo e($item->name ?? ''); ?></span>  
  ...
  <table width="100%" class="list">
    ...
    <tr>
      ...
      <td width="40%" class="list-td">
        ...
        <img src="<?php echo e(URL::asset('public/pdfImage/state_image/'.($state->name ?? '').'.png')); ?>" alt="" style="display: block; margin: auto; max-width: 100%;"/>
      ...
      <td class="list-td" width="60%">
        ...
        <table  width="100%">
          ...
          <tr style="background:#c55a11;">
            ...
            <th style="color:#fff;" colspan="2"><?php echo e($value->name ?? ''); ?> Branch & Agency – Wave - IV – Overview</th>
          ...
          <tr>
            ...
            <td style="width:50%"> <?php echo e(($date[$value->id]['start']!=null)?$date[$value->id]['start']->format('jS M, Y'):''); ?></td>
          ...
          <tr>
            ...
            <td style="width:50%"> <?php echo e(($date[$value->id]['end']!=null)?$date[$value->id]['end']->format('jS M, Y'):''); ?></td>
        ...
        <table  width="100%">
          ...
          <tr>
            ...
            <td style="width:50%"><?php echo e(($collectioncount[$value->id]>9)?$collectioncount[$value->id]:'0'.$collectioncount[$value->id]); ?>
          ...
          <tr>
            ...
            <td style="width:50%"> <?php echo e(($agencycount[$value->id]>9)?$agencycount[$value->id]:'0'.$agencycount[$value->id]); ?>
          ...
          <tr>
            ...
            <td style="width:50%"> <?php echo e(($totalrepoYard>9)?$totalrepoYard:'0'.$totalrepoYard); ?>
        ...
        <table  width="100%">
          ...
          <tr>
            <td  style="width:50%;" align="center"> 
              ...
              <?php $__currentLoopData = $product[$value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <span style="display: inline-block;text-align: center;">
                ...
                <?php if(file_exists('pdfImage/product_logo/'.$productname.'.png')): ?>

                <img src="<?php echo e(URL::asset('public/pdfImage/product_logo/'.$productname.'.png')); ?>" style="width: 30px;" alt="<?php echo e($productname); ?>">
            ...
            <td  style="width:50%;" align="center"> 
              ...
              <?php $__currentLoopData = $productAgency[$value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <span style="display: inline-block;text-align: center;">
                ...
                <img src="<?php echo e(URL::asset('public/pdfImage/product_logo/'.$productname.'.png')); ?>" style="width: 30px;">
  ...
  <div class="footer">
    ...
    <div style="width:33%;display:inline-block;text-align:center;">
      ...
      <div>
        ...
        <img src="<?php echo e(URL::asset('public/pdfImage/footer-middle.jpg')); ?>" style="width: 100px;">
...
<div class="pageA4" style="position: relative;padding-bottom:45px;margin-bottom: 28px; background:#fff; margin-bottom: 50px; padding:50px;">
  ...
  <table  width="100%">
    ...
    <tr>
      ...
      <td align='left'><h2 style="margin:0px;text-align:left;"> <?php echo e($value->name ?? ''); ?> - Branch - Product Score Card
...
<table class="exceptional" width="100%" style="margin-bottom: 100px; text-align: left;">
  ...
  <tbody>
    ...
    <?php if(isset($branchProduct[$value->id])): ?>

    <?php $__currentLoopData = $branchProduct[$value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr>
      ...
      <td class="red"><?php echo e($i++); ?></td>

      <td class="red"> <?php echo e($product_name[$key] ?? ''); ?> Overall</td>

      <td class="red"> <?php echo e($totalScoredProduct); ?> </td>

      <td class="red"><?php echo e($totalScroableProduct); ?> </td>

      <?php if($totalScroableProduct!=0): ?>

      <td class="red"><?php echo e(round(($totalScoredProduct/$totalScroableProduct)*100,2)); ?>%</td>
    ...
    <tr>
      ...
      <tr>
        ...
        <td><?php echo e((count($item)==1)?$i++:''); ?></td>

        <td><?php echo e($product_name[$key] ?? ''); ?></td>

        

        <td><?php echo e($v['scored']); ?></td>

        <td><?php echo e($v['scoreable']); ?></td>

        <?php if($v['scoreable']!=0): ?>

        <td><?php echo e(round(($v['scored']/$v['scoreable'])*100,2)); ?>%</td>
        ...
        <td> <?php echo e($v['collection_manager'] ?? ''); ?> </td>

        

        <td><?php echo e($v['reporting_manager'] ?? ''); ?> </td>
  ...
  <div class="footer">
    ...
    <div style="width:33%;display:inline-block;"><img src="<?php echo e(URL::asset('public/pdfImage/logo-qdegrees.png')); ?>" style="height: 38px;"></div>
...
<?php if(isset($collectionmanager[$value->id])): ?>

<?php $__currentLoopData = $collectionmanager[$value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="pageA4 mastertab" style="position: relative;padding-bottom:45px;margin-bottom: 28px; background:#fff; margin-bottom: 50px; padding:50px;">
  ...
  <table  width="100%">
    ...
    <tr>
      ...
      <td align='left'><h2 style="margin:0px;text-align:left;"><?php echo e($value->name ?? ''); ?> - Collection Manager Score Card
...
<table class="exceptional tab2"  width="100%" style=" margin: 30px 0px;">
  ...
  <tbody>
    ...
    <?php $__currentLoopData = $item['product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agencysingle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
...
<tr>
  ...
  <td> <?php echo e($type); ?>- <?php echo e($product_name[$ke] ?? ''); ?></td>

  <td><?php echo e($agencysingle['agency'] ?? ''); ?> </td>

  <td><?php echo e($agencysingle['scored']); ?></td>

  <td><?php echo e($agencysingle['scoreable']); ?></td>

  <?php if($agencysingle['scoreable']!=0): ?>

  <td style="background:#f8cbaa;"><?php echo e(round(($agencysingle['scored']/$agencysingle['scoreable'])*100,2)); ?>%</td>
...
<?php endif; ?>
              ...
              <tbody>
                  ...
                  if(!empty($getValues))
               {
                ...
                { if(isset($printData['scored']) && $printData['scored'] !=0){?><tr>
                  <td><?php echo e($printData['type'] ?? ''); ?>Score (<?php echo e($keyss); ?>%)</td>
                  <td><?php echo e($printData['scored'] ?? 0); ?></td>
                  <td><?php echo e($printData['scoreable'] ?? 0); ?></td>
                  <td><?php echo e($printData['score%'] ?? 0); ?></td>
                </tr>
              <?php } }?>
               <tr>
                  <td class="red">Final Score </td>

                  <td class="red"> <?php echo e($finalTotalValues['scored'] ?? 0); ?> </td>

                  <td class="red"> <?php echo e($finalTotalValues['scoreable']?? 0); ?> </td>

                  <?php if(isset($finalTotalValues['scored']) && $finalTotalValues['scoreable']!=0): ?>

                  <td class="red"><?php echo e(round(($finalTotalValues['scored']/$finalTotalValues['scoreable'])*100,2)); ?>%</td>
             ...
             <?php }
              ...
              <?php  }else{
                ...
                <tr>
                  ...
                  <td class="red"> <?php echo e($finalTotalValues['scored'] ?? 'Excluded'); ?> </td>

                  <td class="red"> <?php echo e($finalTotalValues['scoreable']?? 'Excluded'); ?> </td>
    ...
    <tr>
      ...
      <td class="red"> <?php echo e($item['collection_manager'] ?? ''); ?>  </td>

      <td class="red"><?php echo e((isset($item['collection_manager_empid']) && $item['collection_manager_empid']!='')? $item['collection_manager_empid'] : 'NA'); ?>   </td>
       <td class="red"> <?php echo e($item['collection_manager_baselocation'] ?? ''); ?>  </td>
      <?php
...
<div class="footer">
  ...
  <div style="width:33%;display:inline-block;text-align:right;">
    ...
    <div><img src="<?php echo e(URL::asset('public/pdfImage/footer-right.jpg')); ?>"></div>
...
</script><?php /**PATH /home/qdegrees/public_html/idfc/audit_online/resources/views/pdf/index.blade.php ENDPATH**/ ?>