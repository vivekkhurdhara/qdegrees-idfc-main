						...
						<tbody>
							...
							<tr scope="row">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(url('download-file-artifact/'.Crypt::encrypt($row->id))); ?>" target="_blank">Download</a>
                                    <?php endif; ?>
								</td>
                                <td nowrap>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/audit/resources/views/Artifact/list.blade.php ENDPATH**/ ?>