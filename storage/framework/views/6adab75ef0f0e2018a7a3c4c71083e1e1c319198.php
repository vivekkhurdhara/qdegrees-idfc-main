                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <select name="lob" class="form-control" id="lob">
                            ...
                            <option value="credit_card" <?php echo e(($lob =='credit_card')?'selected':''); ?>>Credit Card</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qdegrees/public_html/idfc/audit_online/resources/views/bulkUpload/gap.blade.php ENDPATH**/ ?>