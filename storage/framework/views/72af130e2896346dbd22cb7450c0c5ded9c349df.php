    ...
    <body >
      ...
      z-index: 1;">
        ...
        <div style="display: flex; align-items: center;">
            <img src="<?php echo e(URL::asset('pdfImage/logo.jpg')); ?>" class="" alt="" style="height:  60px;"/>
                ...
                <div class="right" style="background: #cccd; padding: 20px;">                    
                   <div style="padding-left: 15px; background: #fff;"> <div style="background: #fff; padding: 15px; border-left: 20px solid brown;">
                    <div class="" style="margin-bottom: 15px;">
                      <img src="<?php echo e(URL::asset('pdfImage/logo.jpg')); ?>" class="" alt="" style="height:  50px;"/>
                      <img src="<?php echo e(URL::asset('pdfImage/logo-qdegrees.png')); ?>" class="" alt="" style="height:  50px; float: right;"/>
                    </div>
                    <img src="<?php echo e(URL::asset('pdfImage/background.jpg')); ?>" alt="" style="width: 100%;" class=""/>
                    <?php if(!empty($getBranch) && !empty($getState)): ?>
                    <h3 contenteditable="true" align="right"><?php echo e($getState->name); ?> <?php echo e($getBranch->name); ?> AUDIT REPORT–WAVE-<?php echo e($quarter); ?> [FY <?php echo e($year); ?>]</h3>
                    <?php else: ?>
                     <h3 contenteditable="true" align="right">KARNATAKA BANGALORE AUDIT REPORT–WAVE–VII- Q3_OCT [FY 2020-21]</h3><?php endif; ?>
...
Highcharts.chart('container', {
   ...
   <?php /**PATH /home/qdegrees/public_html/idfc/audit_online/resources/views/audit_report/create.blade.php ENDPATH**/ ?>