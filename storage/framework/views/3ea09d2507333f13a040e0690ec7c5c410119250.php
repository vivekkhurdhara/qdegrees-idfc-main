...
<?php if($type=='agency' || $type=='yard'): ?>
    ...
    <div class="col-md-3 form-group">
        ...
        <input  type="text" name="agency_manager" class="form-control" value="<?php echo e($agency->user->name ?? ''); ?>" data-id="<?php echo e($agency->user->id ?? ''); ?>" disabled>
...
<?php /**PATH /var/www/html/audit/resources/views/audit/branchQc.blade.php ENDPATH**/ ?>