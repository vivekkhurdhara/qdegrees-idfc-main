...
class AuditController extends Controller
{
    ...
    public function detail_audit_sheet_edit($qm_sheet_id)
    {
        ...
        ->get()->toArray();
    	return view('audit.detail_sheet_edit',compact('qm_sheet_id','data','result','resultPar','resultSubPar','branch','agency','yard','branchRepo','agencyRepo','artifactIds','qc','redalertIds','preview_redalert'));
    }
	...
	$new_ar->latitude = null;
        $new_ar->longitude = null;
	}
    ...
    public function excelDownloadQaChanges(){
        ini_set('memory_limit', '-1');
        ini_set('max_execution_time', 3000);
        return Excel::download(new QcAndQaChangesExport, 'Qa_changes.xlsx');
    }
}
