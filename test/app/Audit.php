...

{
    ...
    protected $fillable=['qm_sheet_id','audited_by_id','is_critical','overall_score','branch_id','product_id','yard_id','agency_id','collection_manager_email','agency_manager_email','yard_manager_email','collection_manager_id'];
