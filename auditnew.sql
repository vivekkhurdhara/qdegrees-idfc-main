...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2020 at 05:39 PM
...
CREATE TABLE `saved_audits` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `audit_id` bigint(20) UNSIGNED NOT NULL,
  `status` tinyint(4) NOT NULL COMMENT '1 for saved',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `saved_audits`
--
...
--
-- AUTO_INCREMENT for table `qcs`
--
ALTER TABLE `qcs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `qm_sheets`
--
ALTER TABLE `qm_sheets`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `qm_sheet_parameters`
--
ALTER TABLE `qm_sheet_parameters`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `qm_sheet_sub_parameters`
--
ALTER TABLE `qm_sheet_sub_parameters`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `red_alerts`
--
ALTER TABLE `red_alerts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `red_alert_answers`
--
ALTER TABLE `red_alert_answers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `saved_audits`
--
ALTER TABLE `saved_audits`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `trail_intensity`
--
ALTER TABLE `trail_intensity`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `yard_repos`
--
ALTER TABLE `yard_repos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `yard_repo_users`
--
ALTER TABLE `yard_repo_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `beat_plans`
--
ALTER TABLE `beat_plans`
  ADD CONSTRAINT `beat_plans_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
